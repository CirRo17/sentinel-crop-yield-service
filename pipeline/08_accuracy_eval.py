"""Step 08: evaluate classification accuracy.

This step compares the postprocessed classification map with independent
validation data and writes standard accuracy products:
...
Validation data can be either a raster label map or a CSV of point samples.
"""
...
def main() -> None:
    ...
    if not args.classification.exists():
        raise FileNotFoundError(f"Missing classification raster: {args.classification}. Run step 07 first.")
